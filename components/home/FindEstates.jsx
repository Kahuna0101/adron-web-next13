    ...
    <section>
      ...
      <div className="w-full flex flex-col md:flex-row mx-auto p-12 md:p-36">
        <div className="flex flex-col w-full md:w-2/5">
          <h1 className="text-5xl font-semibold mt-0 mb-2.5 leading-normal text-white md:text-black">
            Adron Homes helps you make better property decisions
          </h1>
          <p className="text-base font-bold text-white md:text-slate-500">
          ...
          <div className="flex flex-col md:flex-row mt-6 gap-3">
            {abouts.map((about) => (
              <Card
                key={about.id}
                className="flex-1 h-full transition-transform duration-300 hover:scale-110 shadow-lg"
              >
                <CardHeader>
