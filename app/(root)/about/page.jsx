    ...
    <section className="w-full py-32 px-12 md:px-36">
      ...
      <div className="w-full mt-[90px]">
        <div className="flex flex-col justify-center items-center mb-[50px]">
          <h2 className="text-lg text-center text-gray-600">OUR TEAM</h2>
      ...
      <div className="flex justify-center items-center mt-14">
        <div className="flex flex-row gap-1 border rounded-full justify-center items-center w-fit p-4">
          ...
          <Link href="/contact">
            <Button className="text-lg font-medium text-green-500 hover:text-black bg-transparent hover:bg-transparent">
              We are hiring 👔
            </Button>
          </Link>
        </div>
